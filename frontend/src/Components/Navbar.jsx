    ...
    <div className='relative'>
        ...
        <div className="flex flex-col h-full justify-between p-6">
            <div className='flex flex-col gap-3'>
                ...
                <button className="px-4 py-2 w-full text-lg bg-gray-200 rounded hover:bg-gray-300">New company to add</button>
                <button className="px-4 py-2 w-full text-lg bg-gray-200 rounded hover:bg-gray-300">View added companies</button>
            </div>
